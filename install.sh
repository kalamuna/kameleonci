...
echo ""
echo "Next steps:"
echo "1. Configure your repository variables and secrets:"
...
echo "   - SSH_KEY: SSH private key (as a secret)"
echo ""
echo "   For Pantheon sites also add:"
echo "   - PANTHEON_SITE_NAME: Your Pantheon site name"
echo "   - PANTHEON_MACHINE_TOKEN: Terminus machine token (as a secret)"
echo ""
if [[ $needs_build =~ ^[Yy]$ ]]; then
